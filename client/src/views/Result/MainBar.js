...
const styles = theme => ({
  ...
  itemActionable: {
    "&:hover": {
      backgroundColor: "rgba(91, 44, 99, 0.7)"
    }
  },
  itemActiveItem: {
    color: "#914499"
...
const categories = [
  { id: "Dashboard", icon: <TableChartOutlined /> ,path:"/dashboard"},
  { id: "Grade", icon: <GradeOutlined /> ,active: true, path:"/grade"},
  { id: "Settings", icon: <SettingsOutlined /> , path:"/settings"},
  { id: "SignOut", icon: <ExitToAppOutlined/>, path:"/signout" }
];
    ...
    return (
      <div className={classes.root}>
        ...
        <main className={classes.content}>
          ...
          <Heading headings="Grade"></Heading>
          <ResultCard/>
